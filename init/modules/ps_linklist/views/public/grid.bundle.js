...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_grid_extension_link_row_action_extension__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_grid_extension_sorting_extension__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_grid_extension_position_extension__ = __webpack_require__(7);
...
$(function () {
  ...
  gridDivs.forEach(function (gridDiv) {
    var linkBlockGrid = new __WEBPACK_IMPORTED_MODULE_0__components_grid_grid___default.a(gridDiv.dataset.gridId);

    linkBlockGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_3__components_grid_extension_sorting_extension___default.a());
    linkBlockGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_1__components_grid_extension_link_row_action_extension___default.a());
    linkBlockGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_2__components_grid_extension_action_row_submit_row_action_extension___default.a());
    linkBlockGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_4__components_grid_extension_position_extension___default.a());
  });
});
...
var PositionExtension = function () {
  ...
  _createClass(PositionExtension, [{
    ...
    value: function extend(grid) {
      ...
      grid.getContainer().find('.js-grid-table').tableDnD({
        ...
        onDrop: function onDrop(table, row) {
          return _this2.handlePositionChange(row);
        }
      });
    ...
    value: function handlePositionChange(row) {
      ...
      var positions = this.getRowsPositions();
    ...
    key: 'addIdsToGridTableRows',
    value: function addIdsToGridTableRows() {
      var counter = 0;
    ...
    key: 'updatePosition',
    value: function updatePosition(url, params, method) {
      var isGetOrPostMethod = ['GET', 'POST'].includes(method);
    ...
    key: 'computeMappingBetweenOldAndNewPositions',
    value: function computeMappingBetweenOldAndNewPositions(rowsData) {
      var regex = /^row_(\d+)_(\d+)$/;

      var rowsNb = rowsData.length;
      var positionsBeforeDragAndDrop = {};
      var positionsAfterDragAndDrop = {};
      var mapping = [];

      var rowDataMarker = void 0;
      var rowDataParsedData = void 0;
      var i = void 0;
      var rowID = void 0;
      var rowOldPosition = void 0;
      var rowOldOffset = void 0;
      var rowNewOffset = void 0;
      ...
      var previousRowPositionWithThisOffset = void 0;
...
var _tableSorting = __webpack_require__(3);
