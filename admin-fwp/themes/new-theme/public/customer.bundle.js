 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */var i=window.$,u=function(){function t(){var e=this;(0,r.default)(this,t),i(document).on("change",".js-choice-table-select-all",(function(t){e.handleSelectAll(t)}))}return(0,o.default)(t,[{key:"handleSelectAll",value:function(t){var e=i(t.target),n=e.is(":checked");e.closest("table").find("tbody input:checkbox").prop("checked",n)}}]),t}();e.default=u},29145:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r,o=n(99663),a=(r=o)&&r.__esModule?r:{default:r};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
var i=window.$;e.default=function t(){(0,a.default)(this,t),i(document).on("click",".js-form-submit-btn",(function(t){t.preventDefault();var e=i(this);if(!e.data("form-confirm-message")||!1!==window.confirm(e.data("form-confirm-message"))){var n="POST",r=null;if(e.data("method")){var o=e.data("method"),a=["GET","POST"].includes(o);n=a?o:"POST",a||(r=i("<input>",{type:"_hidden",name:"_method",value:o}))}var u=i("<form>",{action:e.data("form-submit-url"),method:n});r&&u.append(r),e.data("form-csrf-token")&&u.append(i("<input>",{type:"_hidden",name:"_csrf_token",value:e.data("form-csrf-token")})),u.appendTo("body").submit()}}))}},99957:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=a(n(99663)),o=a(n(22600));function a(t){return t&&t.__esModule?t:{default:t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */var i=window.$,u=function(){function t(){var e=this;return(0,r.default)(this,t),{extend:function(t){return e.extend(t)}}}return(0,o.default)(t,[{key:"extend",value:function(t){var e=this;t.getContainer().on("click",".js-delete-customers-bulk-action",(function(n){n.preventDefault();var r=i(n.currentTarget).data("customers-delete-url"),o=i("#"+t.getId()+"_grid_delete_customers_modal");o.modal("show"),o.on("click",".js-submit-delete-customers",(function(){t.getContainer().find(".js-bulk-action-checkbox:checked").each((function(t,n){var r=i(n);e.addCustomerToDeleteCollectionInput(r.val())}));var n=o.find("form");n.attr("action",r),n.submit()}))}))}},{key:"addCustomerToDeleteCollectionInput",value:function(t){var e=i("#delete_customers_customers_to_delete"),n=e.data("prototype").replace(/__name__/g,t),r=i(i.parseHTML(n)[0]);r.val(t),e.append(r)}}]),t}();e.default=u},13186:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=a(n(99663)),o=a(n(22600));function a(t){return t&&t.__esModule?t:{default:t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */var i=window.$,u=function(){function t(){(0,r.default)(this,t)}return(0,o.default)(t,[{key:"extend",value:function(t){var e=this;t.getContainer().find("table.table").find(".ps-togglable-row").on("click",(function(t){t.preventDefault(),e.toggleValue(i(t.delegateTarget))}))}},{key:"toggleValue",value:function(t){var e=t.data("toggleUrl");this.submitAsForm(e)}},{key:"submitAsForm",value:function(t){i("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}]),t}();e.default=u},2573:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=a(n(99663)),o=a(n(22600));function a(t){return t&&t.__esModule?t:{default:t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
var i=window.$},3010:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=a(n(99663)),o=a(n(22600));function a(t){return t&&t.__esModule?t:{default:t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */var i=window.$,u=function(){function t(){(0,r.default)(this,t)}return(0,o.default)(t,[{key:"extend",value:function(t){var e=t.getContainer();e.on("click",".js-remove-helper-block",(function(t){e.remove();var n=i(t.target),r=n.data("closeUrl"),o=n.data("cardName");r&&i.post(r,{close:1,name:o})}))}}]),t}();e.default=u},50204:(t,e,n)=>{"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=a(n(99663)),o=a(n(22600));function a(t){return t&&t.__esModule?t:{default:t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
...
/**
                    ...
                    * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
                    */
(0,window.$)((function(){var n=new t.default("customer");n.addExtension(new e.default),n.addExtension(new r.default),n.addExtension(new o.default),n.addExtension(new i.default),n.addExtension(new u.default),n.addExtension(new c.default),n.addExtension(new l.default),n.addExtension(new s.default),n.addExtension(new m.default),n.addExtension(new p.default),n.addExtension(new h.default),n.addExtension(new y.default);var g=new t.default("customer_discount");g.addExtension(new d.default),g.addExtension(new s.default);var w=new t.default("customer_address");w.addExtension(new d.default),w.addExtension(new s.default),new b.default("customersShowcaseCard").addExtension(new _.default),new v.default,new f.default,new a.default}))})(),window.customer={}})();