 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */(0,window.$)((function(){var n=new t.default("cart_rule");n.addExtension(new l.default),n.addExtension(new i.default),n.addExtension(new e.default),n.addExtension(new o.default),n.addExtension(new r.default),n.addExtension(new a.default),n.addExtension(new u.default),n.addExtension(new c.default),n.addExtension(new s.default)}))})(),window.cart_rule={}})();